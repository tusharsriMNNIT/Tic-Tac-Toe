...
public class TicTacToe_s extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(13, 14, 28));
        ...
        playerx.setFont(new java.awt.Font("Ubuntu", 1, 48)); // NOI18N
        ...
        playero.setFont(new java.awt.Font("Ubuntu", 1, 48)); // NOI18N
        ...
        reset.setFont(new java.awt.Font("Ubuntu", 1, 48)); // NOI18N
        reset.setText("Reset");
        ...
        exit.setFont(new java.awt.Font("Ubuntu", 1, 48)); // NOI18N
        exit.setText("Exit");
    ...
    private void exitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame,"Confirm if you wants to exit?","Tic Tac Toe",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
        {
            System.exit(0);
        }
